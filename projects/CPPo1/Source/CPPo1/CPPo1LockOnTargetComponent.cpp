...
UCPPo1LockOnTargetComponent::UCPPo1LockOnTargetComponent()
{
	PrimaryComponentTick.bCanEverTick = false;
}

FVector UCPPo1LockOnTargetComponent::GetLockOnWorldLocation() const
{
...
void UCPPo1LockOnTargetComponent::FindLockOnTargetsInRadius(UObject* WorldContextObject, FVector Origin, float Radius, TArray<AActor*>& OutTargets)
{
	OutTargets.Reset();
	...
	{
		AActor* A = *It;
		if (A && A->FindComponentByClass<UCPPo1LockOnTargetComponent>())
		{

...
protected:
	...
	/** Current lock-on target (enemy or other actor with CPPo1LockOnTargetComponent) */
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category ="CPPo1|Ghost")
...
public:
	...
	UFUNCTION(BlueprintCallable, Category="CPPo1|Ghost")
	virtual void SetGhostCharacter(ACombatCharacter* Ghost);

	/** Get the ghost character (if any). */
	UFUNCTION(BlueprintPure, Category="CPPo1|Ghost")
...
public:
	...
	/** Current HP accessor used by HUD and UI systems. */
	UFUNCTION(BlueprintPure, Category="Damage")
	float GetCurrentHP() const { return CurrentHP; }

	/** Max HP accessor used by HUD and UI systems. */
	UFUNCTION(BlueprintPure, Category="Damage")
